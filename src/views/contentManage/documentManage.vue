        ...
        <div class="category-content">
            <el-table :data="list">
                ...
                <el-table-column label="时间">
                    <template scope="scope">
                        {{getTimeFromat(scope.row.createTimestamps)}}
                    </template>
                </el-table-column>
        ...
        methods: {
            ...
            async getList() {
                let param = {
                    ...
                    startTime: '',
                    endTime: '',
                    page: this.pagenation.pageNum - 1,
                ...
                const {data} = await this.api.findContentList(param);
            ...
            async getSouceList() {
                const {data} = await this.api.getContentSource();
                if (data.result) {
                    this.sourceEnum = data.result;
                }
            },
